...
def extract_questions_with_ai(**context):
    ...
    prompt = f"""
You are an expert at extracting questions from Broker Dealer Platform Questionnaires.
...
def generate_answers_with_ai(**context):
    ...
    for q_num, question_data in questions_with_id.items():
        ...
        prompt_answer = f"""
You are an expert answering Broker Dealer Platform Questionnaire questions for our firm.
