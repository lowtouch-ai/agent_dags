...
def extract_questions_with_ai(**context):
    ...
    prompt = f"""
You are an expert at extracting questions from OCIO RFPs.
...
def generate_answers_with_ai(**context):
    ...
    for q_num, question_data in questions_with_id.items():
        ...
        prompt_answer = f"""
You are an expert answering OCIO RFP questions for our firm.
...
# =============================================================================
with DAG(
    dag_id="rfp_ocio_processing_dag",
    default_args=default_args,
    description="Processes OCIO RFPs: Extracts questions, generates answers, updates via API",
    schedule=None,
