...
2. Extract metrics: (Only if current data exists) Uptime = structured['uptime_status']['uptime_last_30days']; median response = structured['response_time']['median'] or mean(response_times['value']); Errors = structured['uptime_status']['errors_last_30days'].
