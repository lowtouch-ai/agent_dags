...
def step_7_compose_final_email(ti, **context):
    ...
    prompt = "compose the final quote  in the form of an email addressed to the customer using american business tone in html; include all details of the articles in tabular format; Include subtotal (after discount), total discount ($ ), total discount percentage (% with no decimal) and shipping to the summary. Provide only the HTML draft of the email, with no introductory or concluding sentences outside the HTML content."
